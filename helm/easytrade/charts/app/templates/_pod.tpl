  ...
  containers:
    - name: {{ .Chart.Name }}
      ...
      {{- with .Values.env }}
        ...
        {{- end }}
      {{- end }}
      {{- with .Values.problemPatterns }}
        - name: ENABLE_DB_NOT_RESPONDING
          value: {{ .dbNotResponding | default false | quote }}
        - name: ENABLE_ERGO_AGGREGATOR_SLOWDOWN
          value: {{ .ergoAggregatorSlowdown | default false | quote }}
        - name: ENABLE_FACTORY_CRISIS
          value: {{ .factoryCrisis | default false | quote }}
        - name: ENABLE_CREDIT_CARD_MELTDOWN
          value: {{ .creditCardMeltdown | default false | quote }}
        - name: ENABLE_HIGH_CPU_USAGE
          value: {{ .highCpuUsage | default false | quote }}
      {{- end }}
      ports:
